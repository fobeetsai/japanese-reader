...
body[data-ruby-mode="mask"] rt:hover,
...
body[data-ruby-mode="mask"] .sentence-jp-text:hover ruby rt,
body[data-ruby-mode="mask"] .sentence-jp-text.revealed ruby rt,
body[data-ruby-mode="mask"] #selectedSentenceJp:hover ruby rt,
body[data-ruby-mode="mask"] #selectedSentenceJp.revealed ruby rt,
body[data-ruby-mode="mask"] #selectedSentenceJp ruby:hover rt,
body[data-ruby-mode="mask"] .sentence-words-table tr:hover ruby rt,
body[data-ruby-mode="mask"] .sentence-words-table tr.revealed ruby rt,
body[data-ruby-mode="mask"] #allWordsTableTbody tr:hover ruby rt,
body[data-ruby-mode="mask"] #allWordsTableTbody tr.revealed ruby rt,
body[data-ruby-mode="mask"] .all-words-table tr:hover ruby rt,
